/**
 * A responsive drawer (comntrolled component). So on desktop screens, the desktop drawer markup is shown
 * (that's the main markup for this component). Of course, then on smaller screens the main markup is hidden,
 * and a button is shown to toggle the 'MiniDrawer' component, which is our off-canvas.
 */
