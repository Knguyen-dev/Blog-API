...
export default function EmployeeGrid() {
	...
	// The open states of the 'Add Employe' and 'Remove Employee' dialogs
	...
	// Handles the opening and closing of the add employee dialog
	const handleOpenAddEmployee = () => setOpenAddEmployee(true);
	const handleCloseAddEmployee = () => setOpenAddEmployee(false);

	// Handles the opening and closing of the remove employee dialog
	const handleOpenRemoveEmployee = () => setOpenRemoveEmployee(true);
	const handleCloseRemoveEmployee = () => setOpenRemoveEmployee(false);
	...
	return (
		<Box>
			<EditSelectGrid
				...
				columns={columns}
				handleAddItem={handleOpenAddEmployee}
				handleRemoveItem={handleOpenRemoveEmployee}
			...
			{openAddEmployee && (
				<AddEmployeeDialog
					open={true}
					handleOpen={handleOpenAddEmployee}
